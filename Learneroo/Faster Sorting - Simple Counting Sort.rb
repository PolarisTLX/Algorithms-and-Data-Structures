https://www.learneroo.com/modules/4/nodes/16

THIS IS MUCH SIMPLER AND FASTER THAN INSERTION SORT!!!

Compare to previous exercise to full understanding:  https://www.learneroo.com/modules/4/nodes/15
...
PREVIOUS EXERCISE WAS TO JUST COUNT NUMBER OF INSTANCES AS YOU RAN THROUGH IT
PREVIOUS EXERCISE CODE IS ONLY DIFFERENT BY 2 LINES:

while i <= max do
  count = 0
  ar.each do |element|
    count += 1 if element == i
  end
  print count, " "
  i += 1
end
...
(The number 1 appears 2 times, etc...):
